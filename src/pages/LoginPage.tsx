        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="mt-6 pt-5 border-t border-slate-800/80 text-center space-y-3">
              <div className="p-3.5 rounded-xl bg-slate-950/60 border border-slate-800/80 text-left space-y-1.5 text-xs text-slate-300">
                <div className="flex items-center gap-2 text-[#D4AF37] font-semibold text-[11px] font-mono uppercase tracking-wider">
              ...
              <div className="pt-2">
                <Link to="/" className="text-xs text-slate-500 hover:text-[#D4AF37] transition-colors inline-flex items-center gap-1">
