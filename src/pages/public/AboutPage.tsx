    ...
    <div className="space-y-16 sm:space-y-24 pb-16 font-sans">
      ...
      <section className="pt-8 sm:pt-14 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center space-y-4">
        ...
        <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight max-w-3xl mx-auto">
          ...
          <span className="text-[#D4AF37]">not create them.</span>
        </h1>
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {/* Mission Card */}
          <div className="p-8 sm:p-10 rounded-3xl bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-slate-900 text-white border border-slate-800 shadow-xl space-y-4">
            <div className="w-12 h-12 rounded-2xl bg-amber-400/20 text-[#D4AF37] flex items-center justify-center">
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 rounded-3xl bg-white dark:bg-[#0B0F17] border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            <div className="w-10 h-10 rounded-xl bg-blue-500/10 text-blue-600 flex items-center justify-center">
              <Code2 className="w-5 h-5" />
            </div>
            <h3 className="text-base font-bold text-slate-900 dark:text-white">Strict Type Safety</h3>
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-[#0B0F17] border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900 dark:text-white">Relational Integrity</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-[#0B0F17] border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900 dark:text-white">Cryptographic Security</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-[#0B0F17] border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900 dark:text-white">Pragmatic Automation</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-[#0B0F17] border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900 dark:text-white">Practical AI Utility</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-[#0B0F17] border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900 dark:text-white">Long-Term Ownership</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 flex justify-center lg:justify-end">
              <div className="w-48 h-48 rounded-3xl bg-slate-800 border-2 border-[#D4AF37]/40 flex flex-col items-center justify-center p-6 text-center shadow-xl space-y-2">
                <div className="w-16 h-16 rounded-2xl bg-[#D4AF37] text-black font-black text-2xl flex items-center justify-center shadow-md">
                  MS
                </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center space-y-6">
        <div className="p-8 sm:p-12 rounded-3xl bg-white dark:bg-[#0B0F17] border border-slate-200 dark:border-slate-800 shadow-xl space-y-4 max-w-3xl mx-auto">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              to="/contact"
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 px-6 py-3 rounded-xl bg-slate-950 text-white dark:bg-[#D4AF37] dark:text-black font-bold text-xs shadow-md hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
            ...
            <Link
              to="/projects"
              className="w-full sm:w-auto px-6 py-3 rounded-xl border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/60 text-slate-700 dark:text-slate-200 font-semibold text-xs transition-colors"
            >
