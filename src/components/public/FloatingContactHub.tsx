    ...
    <>
      <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end space-y-3 font-sans">
        ...
        {isOpen && (
          <div className="flex flex-col space-y-2 mb-2 animate-fade-in bg-white p-3 rounded-2xl shadow-2xl border border-[#E2E5E0] w-60">
            ...
            <a
              ...
              className="flex items-center space-x-3 p-2 rounded-xl text-slate-800 hover:bg-emerald-50 hover:text-emerald-700 transition-colors group"
            >
            ...
            <a
              ...
              className="flex items-center space-x-3 p-2 rounded-xl text-slate-800 hover:bg-blue-50 hover:text-blue-700 transition-colors group"
            >
            ...
            <a
              ...
              className="flex items-center space-x-3 p-2 rounded-xl text-slate-800 hover:bg-amber-50 hover:text-amber-700 transition-colors group"
            >
              ...
              <div className="flex-1 text-left truncate">
                ...
                <div className="text-[10px] text-slate-500 truncate">{companyConfig.contact.email}</div>
              </div>
            </a>
            ...
            <button
              ...
              className="flex items-center space-x-3 p-2 rounded-xl text-slate-800 hover:bg-slate-100 hover:text-slate-950 transition-colors group text-left w-full"
            >
              ...
              <div className="flex-1 text-left">
                <div className="text-xs font-bold leading-tight">WeChat Official</div>
        ...
        <button
          ...
          className="flex items-center space-x-2 px-4 py-3 rounded-full bg-[#111827] text-white font-semibold text-xs shadow-xl shadow-black/20 hover:bg-[#1F2937] hover:scale-105 active:scale-95 transition-all duration-200 border border-[#111827] group"
