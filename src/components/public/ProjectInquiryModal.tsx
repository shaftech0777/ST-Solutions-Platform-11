            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-900 flex items-center space-x-1">
                    ...
                    <span className="text-slate-500 dark:text-slate-400 text-[10px] font-normal">(Optional)</span>
                  </label>
                  <input
                    type="text"
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-900 flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-slate-500 dark:text-slate-400 font-normal">Min 10 characters</span>
                </label>
                <textarea
                  required
                  rows={4}
