...
export const PublicFooter: React.FC = () => {
  ...
  return (
    <footer className="bg-[#090A0F] text-slate-300 border-t border-slate-800 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative z-10 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link to="/" className="flex items-center space-x-3 group">
              <div className="w-10 h-10 rounded-xl bg-slate-900 border border-amber-400/40 flex items-center justify-center text-[#D4AF37] font-extrabold text-sm tracking-wider shadow-sm group-hover:border-[#D4AF37] transition-all">
                ST
              </div>
            ...
            {/* Founder Note & Link */}
            <div className="pt-2">
              <div className="p-3.5 rounded-xl bg-slate-900/90 border border-slate-800/90 space-y-2 max-w-sm">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-slate-400">{companyConfig.founder.role}</div>
                    </div>
                  </div>
                </div>
                <a
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-xs">
              ...
              >
                ...
                <span>WeChat: {companyConfig.contact.weChatId}</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800/80 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <div className="flex items-center space-x-2">
            ...
            <span>•</span>
            <span className="text-slate-400">Enterprise Technology Partner</span>
          </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <Link to="/apply" className="hover:text-slate-300 transition-colors">
              Careers / Apply
            </Link>
            <a
              href={companyConfig.founder.portfolioUrl}
