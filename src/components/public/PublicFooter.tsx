...
export const PublicFooter: React.FC = () => {
  ...
  return (
    <footer className="bg-[#111827] text-slate-300 border-t border-slate-800 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative z-10 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link to="/" className="flex items-center space-x-3 group">
              <div className="w-10 h-10 rounded-xl bg-slate-900 border border-[#D4AF37]/40 flex items-center justify-center text-[#D4AF37] font-extrabold text-sm tracking-wider shadow-sm group-hover:border-[#D4AF37] transition-all">
                ST
              </div>
            ...
            {/* Founder Note & Link */}
            <div className="pt-2">
              <div className="p-3.5 rounded-xl bg-slate-800/80 border border-slate-700 space-y-2 max-w-sm">
          ...
          <div className="space-y-3">
            <h2 className="text-xs font-bold uppercase tracking-wider text-slate-200 font-mono">Legal</h2>
            <ul className="space-y-1 text-sm text-slate-300">
              <li>
        ...
        <div className="border-t border-slate-800 pt-8 pb-4 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          <div className="flex flex-wrap items-center gap-2">
            <span>© 2026 ST-Solutions. All rights reserved.</span>
            <span>•</span>
            <span className="text-slate-300">Enterprise Technology Partner</span>
          </div>
