...
export const ProjectCardVisual: React.FC<ProjectCardVisualProps> = ({ projectId, category }) => {
  ...
  if (projectId.includes("ecommerce") || projectId.includes("retail") || category === "E-Commerce") {
    return (
      <div className="w-full h-44 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl relative overflow-hidden flex flex-col justify-between p-4 border border-slate-300 dark:border-slate-700/60 shadow-inner group-hover:border-amber-500/50 transition-all">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-7 h-7 rounded-lg bg-amber-500/20 border border-amber-500/30 flex items-center justify-center text-amber-400">
              <ShoppingBag className="w-4 h-4" />
            </div>
            <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">Apex Storefront</span>
          </div>
        ...
        <div className="bg-slate-800/80 border border-slate-300 dark:border-slate-700 rounded-xl p-3 space-y-2">
      ...
      <div className="w-full h-44 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl relative overflow-hidden flex flex-col justify-between p-4 border border-slate-300 dark:border-slate-700/60 shadow-inner group-hover:border-amber-500/50 transition-all">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">Medix Pharmacy POS</span>
          </div>
        ...
        <div className="bg-slate-800/80 border border-slate-300 dark:border-slate-700 rounded-xl p-3 space-y-1.5">
          ...
          <div className="flex items-center justify-between text-[10px] text-slate-500 dark:text-slate-400">
            ...
            <span className="text-slate-700 dark:text-slate-300 font-medium">Exp: Nov 2027</span>
          </div>
        </div>
      ...
      <div className="w-full h-44 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl relative overflow-hidden flex flex-col justify-between p-4 border border-slate-300 dark:border-slate-700/60 shadow-inner group-hover:border-amber-500/50 transition-all">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">BistroOrder POS &amp; QR</span>
          </div>
          <span className="px-2 py-0.5 rounded-md bg-emerald-500/20 text-emerald-300 text-[10px] font-semibold border border-emerald-500/30">
            0% Commission
          </span>
        ...
        <div className="bg-slate-800/80 border border-slate-300 dark:border-slate-700 rounded-xl p-3 space-y-1.5">
          <div className="flex items-center justify-between text-[11px] text-slate-700 dark:text-slate-300">
            <span className="font-semibold text-slate-900 dark:text-white">Table 04 • Live KDS Ticket</span>
        ...
        <div className="flex items-center justify-between text-[10px] text-slate-500 dark:text-slate-400">
          ...
          <span className="text-slate-900 dark:text-white font-medium">Thermal Print Ready</span>
        </div>
      </div>
    );
  }
      ...
      <div className="w-full h-44 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl relative overflow-hidden flex flex-col justify-between p-4 border border-slate-300 dark:border-slate-700/60 shadow-inner group-hover:border-amber-500/50 transition-all">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">Pulse Operations Hub</span>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="bg-slate-800/80 border border-slate-300 dark:border-slate-700 rounded-lg p-2 text-center">
            <div className="text-[9px] text-slate-500 dark:text-slate-400">PIPELINE</div>
            <div className="text-xs font-bold text-slate-900 dark:text-white">$48.5k</div>
          </div>
          <div className="bg-slate-800/80 border border-slate-300 dark:border-slate-700 rounded-lg p-2 text-center">
            <div className="text-[9px] text-slate-500 dark:text-slate-400">ACTIVE</div>
            <div className="text-xs font-bold text-amber-400">14 Deals</div>
          </div>
          <div className="bg-slate-800/80 border border-slate-300 dark:border-slate-700 rounded-lg p-2 text-center">
            <div className="text-[9px] text-slate-500 dark:text-slate-400">PAID</div>
      ...
      <div className="w-full h-44 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl relative overflow-hidden flex flex-col justify-between p-4 border border-slate-300 dark:border-slate-700/60 shadow-inner group-hover:border-amber-500/50 transition-all">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">OmniBot AI Assistant</span>
          </div>
          <span className="px-2 py-0.5 rounded-md bg-emerald-500/20 text-emerald-300 text-[10px] font-semibold border border-emerald-500/30">
            24/7 Live
          </span>
        ...
        <div className="bg-slate-800/80 border border-slate-300 dark:border-slate-700 rounded-xl p-3 space-y-1.5 text-[10px]">
          <div className="text-slate-500 dark:text-slate-400 flex items-center space-x-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-purple-400" />
            <span className="text-slate-700 dark:text-slate-300">Customer: &quot;What are your pricing packages?&quot;</span>
          </div>
      ...
      <div className="w-full h-44 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl relative overflow-hidden flex flex-col justify-between p-4 border border-slate-300 dark:border-slate-700/60 shadow-inner group-hover:border-amber-500/50 transition-all">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">EduSphere Portal</span>
          </div>
        ...
        <div className="bg-slate-800/80 border border-slate-300 dark:border-slate-700 rounded-xl p-3 space-y-1.5">
          <div className="flex items-center justify-between text-[10px] text-slate-700 dark:text-slate-300">
            <span className="font-semibold text-slate-900 dark:text-white">Monthly Fee Reconciliation</span>
            <span className="text-emerald-400 font-mono font-bold">94% Collected</span>
          </div>
          <div className="text-[10px] text-slate-500 dark:text-slate-400 flex items-center justify-between">
            <span>Automated SMS Voucher Sent</span>
            <span className="text-slate-700 dark:text-slate-300">420 Students</span>
          </div>
        </div>
      ...
      <div className="w-full h-44 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl relative overflow-hidden flex flex-col justify-between p-4 border border-slate-300 dark:border-slate-700/60 shadow-inner group-hover:border-amber-500/50 transition-all">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">StockFlow Inventory</span>
          </div>
        ...
        <div className="flex items-center justify-between text-[10px] text-slate-500 dark:text-slate-400">
          ...
          <span className="text-slate-900 dark:text-white font-medium">99.4% Accuracy</span>
        </div>
      </div>
    );
  }
      ...
      <div className="w-full h-44 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl relative overflow-hidden flex flex-col justify-between p-4 border border-slate-300 dark:border-slate-700/60 shadow-inner group-hover:border-amber-500/50 transition-all">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">AppointEase Booking</span>
          </div>
          <span className="px-2 py-0.5 rounded-md bg-emerald-500/20 text-emerald-300 text-[10px] font-semibold border border-emerald-500/30">
            -75% No-Shows
          </span>
        ...
        <div className="bg-slate-800/80 border border-slate-300 dark:border-slate-700 rounded-xl p-3 space-y-1.5">
          <div className="flex items-center justify-between text-[10px] text-slate-700 dark:text-slate-300">
            <span className="font-semibold text-slate-900 dark:text-white">Tomorrow • 10:30 AM</span>
            <span className="text-emerald-400 font-medium">Confirmed</span>
          </div>
          <div className="flex items-center justify-between text-[10px] text-slate-500 dark:text-slate-400">
            <span>WhatsApp Reminder Sequence</span>
            <span className="text-slate-700 dark:text-slate-300">Google Calendar Synced</span>
          </div>
        </div>
    ...
    <div className="w-full h-44 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl relative overflow-hidden flex flex-col justify-between p-4 border border-slate-300 dark:border-slate-700/60 shadow-inner group-hover:border-amber-500/50 transition-all">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xs font-bold text-slate-900 dark:text-white tracking-wide">Corporate Digital Platform</span>
        </div>
        <span className="px-2 py-0.5 rounded-md bg-emerald-500/20 text-emerald-300 text-[10px] font-semibold border border-emerald-500/30">
          100/100 PageSpeed
        </span>
      ...
      <div className="bg-slate-800/80 border border-slate-300 dark:border-slate-700 rounded-xl p-3 space-y-1.5">
        <div className="flex items-center justify-between text-[10px] text-slate-700 dark:text-slate-300">
          <span className="font-semibold text-slate-900 dark:text-white">High-Authority Architecture</span>
